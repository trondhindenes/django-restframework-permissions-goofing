...
class TaskTest(TestCase):
    ...
    def test_direct_permissions(self):
        ...
        # self.assertFalse(user1.has_perm("assign_task", task1))

        # assign_perm('assign_task', user1, task1)
    ...
    def test_direct_group_permissions(self):
        ...
        # assign_perm(perm="assign_task", user_or_group=group1, obj=task1)
        self.assertTrue(user1.has_perm("quickstart.change_task", task1))

        # self.assertFalse(user2.has_perm("assign_task", task1))
